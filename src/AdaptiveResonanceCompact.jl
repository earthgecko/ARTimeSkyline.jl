# This code is derived from https://github.com/markNZed/ARTimeNAB.jl/blob/main/src/AdaptiveResonance.jl
# which was derived from https://github.com/AP6YC/AdaptiveResonance.jl
...
#
# Other than additions to these header comments there is no change in the
# ARTimeSkyline AdaptiveResonance.jl from the markNZed/ARTimeNAB.jl source.
